...
out.println();
     out.println("StringBuffer req.getRequestURL()="+req.getRequestURL());     
...
out.println();
     out.println("context.getMimeType(\"xxx.html\")= "+context.getMimeType("xxx.html"));
     out.println("context.getMimeType(\"xxx.txt\")= "+context.getMimeType("xxx.txt"));
     ...
     out.println("context.getMimeType(\"xxx.ppt\")= "+context.getMimeType("xxx.ppt"));
