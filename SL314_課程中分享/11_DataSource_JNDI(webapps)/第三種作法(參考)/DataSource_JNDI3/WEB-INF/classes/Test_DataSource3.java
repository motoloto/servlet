/** 自行取得DataSource的 servlet
 ...
 2. 或加入 /conf/Catalina/localhost/DataSource_JNDI3.xml
    ...
    -In individual files (with a ".xml" extension) in the $CATALINA_BASE/conf/[enginename]/[hostname]/ directory.
     This file will always take precedence over any context.xml file packaged in the web application's META-INF directory
 */
import java.io.*;
...
public class Test_DataSource3 extends HttpServlet {
