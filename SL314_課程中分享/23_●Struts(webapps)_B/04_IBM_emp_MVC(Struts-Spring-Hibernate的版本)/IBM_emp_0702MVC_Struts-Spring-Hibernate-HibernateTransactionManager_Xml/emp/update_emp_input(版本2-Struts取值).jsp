	...
	<table border="0">
		...
		<tr>
			...
			<td><input type="TEXT" name="ename" size="45"
				value='<bean:write name="empForm" property="ename" />'></td>
		</tr>
		<tr>
			<td><bean:message key="emp.job" /></td>
			<td><input type="TEXT" name="job" size="45"
				value='<bean:write name="empForm" property="job"/>' />
		</tr>
		<tr>
			...
			<td bgcolor="#CCCCFF">
			    ...
			    value='<bean:write name="empForm" property="hiredate"/>'>
			    <a class="so-BtnLink"
		...
		<tr>
			...
			<td><input type="TEXT" name="sal" size="45"
				value='<bean:write name="empForm" property="sal"/>' />
		</tr>
		<tr>
			<td><bean:message key="emp.comm" /></td>
			<td><input type="TEXT" name="comm" size="45"
				value='<bean:write name="empForm" property="comm"/>' />
		</tr>
