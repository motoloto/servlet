...
@WebListener
public class InitializeLeaguesListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent event) {
    ...
    try {
      ...
      System.out.println("ServletContextListener通知:【Servlet 3.0】聯盟的List已成功載入到ServletContext中");
