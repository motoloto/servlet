/*
 * Bazillyo's Spiffy DHTML Popup Calendar v. 1.0 й 2000 S. Ousta
 *   - freeware with this comment
 *   - for download size, you can strip all spaces & comments except the й notices
...
var names     = new makeArray0('д@ды','дGды','дTды','е|ды','днды','д╗ды','дCды','дKды','дEды','дQды','дQд@ды','дQдGды');
